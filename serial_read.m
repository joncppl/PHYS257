try
    ...
    while 1
        ...
        if (mod(iterator, 5*6) ==0)
            ...
            legend(strcat('Resistor Temp (', num2str(resistor_temp(resistor_temp_size)), ')'), ...
                strcat('pin 0 (', num2str(temp_1(temp_1_size)), ')'), ...
                strcat('pin 1 (', num2str(temp_2(temp_2_size)), ')'), ...
                strcat('pin 2 (', num2str(temp_3(temp_3_size)), ')'), ...
                strcat('pin 3 (', num2str(temp_4(temp_4_size)), ')'), ...
                strcat('Ambient Temperature (', num2str(temp_5(temp_5_size)), ')'), ...
                'Avg. Power', ...
