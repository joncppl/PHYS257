    ...
    while 1
        ...
        if (mod(iterator, 5*6) ==0)
            ...
            legend(strcat('Resistor Temp (', num2str(resistor_temp(length(resistor_temp))), ')'), ...
                strcat('pin 0 (', num2str(temp_1(length(temp_1))), ')'), ...
                strcat('pin 1 (', num2str(temp_2(length(temp_2))), ')'), ...
                strcat('pin 2 (', num2str(temp_3(length(temp_3))), ')'), ...
                strcat('pin 3 (', num2str(temp_4(length(temp_4))), ')'), ...
                strcat('Ambient Temperature (', num2str(temp_5(length(temp_5))), ')'), ...
                'Avg. Power', ...
